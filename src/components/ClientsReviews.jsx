...
const ClientsReviews = () => {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="1000" className="bg-blue-950 py-1">
            <div className="max-w-6xl w-[90%] mx-auto my-16">
                ...
                <div>
                    <Marquee pauseOnHover={true}>
                        <div data-aos="zoom-in-up" data-aos-duration="1000" className="bg-white rounded-lg shadow-lg p-4 text-center w-80 h-36 mr-10 ">
